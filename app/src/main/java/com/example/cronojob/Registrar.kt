...
class Registrar : AppCompatActivity() { // Cambia a 'Registrar'
    private lateinit var sharedPreferences: SharedPreferences

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_registrar) // Asegúrate de que este sea el nombre correcto del layout
